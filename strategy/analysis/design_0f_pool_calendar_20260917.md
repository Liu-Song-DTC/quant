...
| **G monthly+0.05/None** | **705,640** | **182.26%** | **1.1656** | **18.00%** | **582** | **693** | **194,637** |
...
**臂G终局: 4-0胜E + 3-1胜F, bracket关闭, G采纳**。NAV 705,640 /
+182.26% / Sharpe 1.1656 / MDD 18.00%。vs E(690,463/176.19%/1.1359/
22.24%): NAV +15,177 / 收益 +6.07pp / Sharpe +0.0297 / MDD −4.24pp
**全胜4-0**。vs F(681,707/172.68%/1.1059/17.87%): NAV +23,933 /
收益 +9.58pp / Sharpe +0.0597 全胜, MDD +0.13pp微败 → **3-1**
(MDD差在噪声级)。rank-sum(6臂重算): **G=5 < E=10=F=10 < D=15 <
C=20 < A=24** — 中心臂碾压双端点, 非鞍点亦非纯flat-top: NAV/Sharpe
曲面在0.05处有真实内部峰。年分解 (G vs E): 2021 +12.00/+18.24
(−6.24pp), 2022 **−4.08/−18.26 (+14.18pp)**, 2023 +6.11/+19.92
(−13.81pp), 2024 +28.76/+38.90 (−10.14pp), 2025 +48.05/+46.30
(+1.75pp), 2026 **+31.40/+17.42 (+13.98pp)** — 4/6年胜。G vs F:
2021 +0.97/2022 +0.82/2023 +2.22/2026 **+18.43pp** 胜, 2024 −10.64/
2025 −9.59败 — 4/6年胜, 2026双杀。vs daily纯基线4-0 (NAV +352,516/
+141.01pp/+0.7014/−18.62pp)。ML avg_IC 0.1121=端点平坦, 闸丢弃
194,637 (E 355,157 > G > F 167,977单调✓), 成交率100%, 跳空罚10买。
**生产yaml已=G配置(0.05/None), bracket收口, 转C5/C1队列**。
