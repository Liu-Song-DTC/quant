...
INDUSTRY_CHAINS: Dict[str, Dict[str, List[str]]] = {
    ...
    # ═══ 消费产业链 ═══
    "消费": {
        "白酒食品":   ["白酒", "酿酒概念", "食品饮料", "预制菜概念"],
        "零售流通":   ["零售概念", "新零售", "免税概念", "社区团购"],
        "旅游文娱":   ["旅游概念", "文娱消费", "短剧互动游戏", "谷子经济"],
        "医药健康":   ["特色药", "单抗概念", "肝炎概念", "CAR-T细胞疗法"],
    },
    # ═══ 资源/材料产业链 ═══
    "资源材料": {
        "有色金属":   ["黄金概念", "稀缺资源", "稀土永磁", "小金属概念"],
        "化工材料":   ["磷化工", "新材料", "碳基材料", "复合集流体"],
        "电力能源":   ["抽水蓄能", "绿色电力", "超超临界发电", "核能核电"],
    },
    # ═══ 基建/海洋产业链 ═══
    "基建海洋": {
        "水利管网":   ["水利建设", "地下管网", "海绵城市"],
        "海洋经济":   ["海洋经济", "海工装备概念", "航运概念"],
