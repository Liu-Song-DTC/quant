...
## 0f-v3.8 relax臂 B/C/D 裁决 (2026-09-19 凌晨)

| 配置 | NAV | 收益 | Sharpe | MDD | 选股 | 买入 | 闸丢弃 |
|------|-----|------|--------|-----|------|------|--------|
| A monthly+1.0/None | 529,676 | 111.87% | 0.8767 | 30.91% | 540 | 639 | 3,623,190 |
| B monthly+0.5/0.10 | 458,575 | 83.43% | 0.7374 | 18.92% | 577 | 634 | 3,504,468 |
| **C monthly+0.5/None** | **588,767** | **135.51%** | **0.9602** | **23.80%** | **572** | **669** | **2,364,540** |
| **D monthly+0.25/None** | **634,165** | **153.67%** | **1.0710** | **20.57%** | **593** | **694** | **1,177,212** |
| E monthly+0.10/None | 690,463 | 176.19% | 1.1359 | 22.24% | 594 | 703 | 355,157 |
| F monthly+0.0/None | 681,707 | 172.68% | 1.1059 | 17.87% | 591 | 708 | 167,977 |
| G monthly+0.05/None | 冷跑中(0919d) | | | | | | |

**臂B否决 (3-1)**: vs A仅MDD胜(−11.99pp, 18.92%为诚实史最浅回撤), NAV
−71,101/收益−28.44pp/Sharpe−0.139全败。年分解: 2021 +10.14pp/2023 +6.33pp
的早期增益被2025 −15.90pp/2026 −20.49pp吞没 — **2026崩塌签名(+4.55%)**,
动量门把2026年恢复中的低地板码全过滤掉了, 自噬。

**臂C 4-0全胜 (采纳候选)**: NAV +59,091 / 收益 +23.64pp / Sharpe +0.0835 /
MDD −7.11pp 全占优。年分解 (C vs A): 2021 −0.51/−16.26 (**+15.75pp**),
2022 −9.77/−9.59 (−0.18pp), 2023 +13.96/+10.52 (+3.44pp), 2024 +16.27/+8.95
(+7.32pp), 2025 +64.48/+81.23 (−16.75pp), 2026 +17.19/+25.04 (−7.85pp)。
4/6年胜, 2026 +17.19%健康无崩塌签名 — **与臂B同地板, 唯一差=去掉动量门,
2026从+4.55恢复到+17.19, 动量门是毒药**。经济画像: 低地板码的alpha在
早期年份(2021/2024), 2025-26动量市里中等回吐但仍正贡献。
union单调 A5051⊂B5147⊂C5176; 掩码 1,927,448→1,855,172→1,252,998; ML
avg_IC 0.0881→0.0959→0.0998, preds 3,074,556→3,145,371→3,129,224。

**臂D决策 (spec条款 "D视A-C结果定|flat-top收口或关闭")**: C干净4-0胜,
但地板轴上仅两点(1.0→529k, 0.5→589k)无法区分峰值与斜坡。P0-2 CSCV纪律=
flat-top中心采纳不追argmax → D=**monthly+0.25/None** (halving延续, 方向探针):
D再胜→最优在更低地板, 继续0.1; D败→0.5为argmax, flat-top收口采纳C。
membership已预构建(d2825a292629, 332,774条, C⊆D +75,967边界-码✓), 冷跑
0919a启动。

**臂D 4-0再胜C (斜坡延续, 峰未见)**: NAV 634,165 / +153.67% / **Sharpe
1.0710 (过1.0项目目标线)** / MDD 20.57%。vs C: NAV +45,398 / 收益 +18.16pp
/ Sharpe +0.1108 / MDD −3.23pp 全占优。年分解 (D vs C): 2021 +11.30/−0.51
(+11.81pp, 序列首个正2021), 2022 −18.97/−9.77 (**−9.20pp, 序列最差2022**),
2023 +6.21/+13.96 (−7.75pp), 2024 +40.79/+16.27 (**+24.52pp**),
2025 +52.56/+64.48 (−11.92pp), 2026 +22.47/+17.19 (+5.28pp)。3/6年胜。
经济画像清晰: 地板越低, 小票alpha年(2021/2024/2026)越强, 2022慢熊越弱 —
低地板码2022年跌更深且难出货。跳空罚13买(vs A 9/C 8) — 低流动性名
跳空增多, 但成交率仍100%。union已饱和5190/5190, 后续地板下降只改变
准入时点不扩union。单调链: 闸丢弃3,623,190→3,504,468→2,364,540→1,177,212,
掩码1,927,448→1,855,172→1,252,998→617,458, ML avg_IC 0.0881→0.0959→
0.0998→**0.1097** (ML层随池放宽持续受益)。

**臂E决策**: halving纪律=斜坡未降则继续 → E=**monthly+0.10/None**
(主板16M/创业8M/科创4M)。D的2022腿−18.97%是警示: E若2022再恶化且
2021/2024增益放缓→flat-top中心≈D(0.25); E若4-0再胜→末探F=0.0纯准入
(仅min_price+60日数据), 序列收口。E的union与D相同(5190饱和)→raw缓存
命中省15min。membership预构建→冷跑0919b。

**臂E 3-1 vs D (首次指标反转: MDD)**: NAV 690,463 / +176.19% / Sharpe
1.1359 / MDD 22.24%。vs D: NAV +56,298 / 收益 +22.52pp / Sharpe +0.0649
全胜, **MDD +1.67pp败**。年分解 (E vs D): 2021 +18.24/+11.30 (+6.94pp),
2022 −18.26/−18.97 (+0.71pp, 2022警示假设被证伪!), 2023 +19.92/+6.21
(**+13.71pp**), 2024 +38.90/+40.79 (−1.89pp), 2025 +46.30/+52.56 (−6.26pp),
2026 +17.42/+22.47 (−5.05pp)。3/6年胜。年度MDD在5/6年系统性加深
(2026 10.7→18.9最显著) — MDD反转是真实趋势不是噪声, 但全期MDD 22.24
仍优于C(23.80)/quarterly(23.13)/A(30.91)。vs daily纯基线(spec裁决对象)
E仍是4-0全胜; 铁律链上D是唯一4-0链胜臂。轴画像: NAV/Sharpe仍陡升
(斜率未降), MDD在0.25处最小 — 无flat-top, 端点未探。跳空罚12买。

**臂F决策 (轴端点收口)**: F=**monthly+0.0/None** — 无流动性地板纯准入
(仅cut≥60+close≥2.0+数据存在), 轴的经济学端点。F完成后按spec裁决
(每臂vs基线四指标)+rank-sum定胜者, 生产yaml落胜者配置, 关闭bracket
转C5/C1队列。membership预构建(bbb0b2719700, 405,565条, E⊆F+15,786✓),
冷跑0919c。

**臂F 1-3 vs E (rank-sum并列7, flat-top需要G)**: NAV 681,707 / +172.68% /
Sharpe 1.1059 / **MDD 17.87% — 诚实配置史最浅回撤**。vs E: NAV −8,756 /
收益 −3.51pp / Sharpe −0.0300 全败, MDD −4.37pp胜。年分解 (F vs E):
2021 +11.03/+18.24 (−7.21pp), 2022 **−4.90/−18.26 (+13.36pp, 序列最佳2022)**,
2023 +3.89/+19.92 (−16.03pp), 2024 +39.40/+38.90 (+0.50pp),
2025 **+57.64/+46.30 (+11.34pp)**, 2026 +12.97/+17.42 (−4.45pp)。
3/6年胜。vs daily纯基线仍是4-0全胜, 铁律链上F是**唯一4-0链胜D的臂**
(D被F四指标全支配)。rank-sum: A=20/C=16/D=10/**E=7/F=7** —
轴两端并列, 无argmax; NAV/Sharpe峰在E, MDD谷在F (F每单位NAV/MDD
=38,149/pp vs E的31,046/pp)。轴画像是斜坡末端分叉: 收益能力与风险
容忍在此张力。跳空罚11买。

**臂G决策 (flat-top中心, 并列裁决)**: E/F并列7 → 按P0-2纪律采纳
flat-top中心 G=**monthly+0.05/None** (主板10M/创业5M/科创2.5M)。若G
落在E/F之间任一指标显著更优→G; 若G≈E/F(flat-top确认)→采纳G为中心
保守收口; 若G四指标劣于E且F→鞍点, 按风险调整(NAV/MDD)采纳F。
membership预构建(d279cbcd9146, 403,057条, E⊆G⊆F+13,278/−2,508✓),
冷跑0919d。
