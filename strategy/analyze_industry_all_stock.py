...
def main():
    print("="*70)
    print("全股票因子挖掘 - 按行业分类，使用全部数据计算IC")
    print("="*70)
    ...
    for industry, stocks in sorted_ind:
        ...
        result = analyze_group(industry, group_data, forward)
        if result:
    ...
    out_path = os.path.join(BASE_DIR, 'strategy/industry_all_stock_factors_ic.json')
